            ...
            >
              ...
              <div className="p-5 space-y-4 flex-1">
                <div className="flex items-center justify-between text-xs">
                  <div>
                    <span className="text-[10px] font-bold text-[#667085] uppercase block">Recipient Conductor</span>
                    <span className="font-bold text-[#171717]">{log.conductorName}</span>
                  </div>
                  <div className="text-right">
                    <span className="text-[10px] font-bold text-[#667085] uppercase block">Bus Plate</span>
                ...
                >
                  Open Conductor Mobile Link <ExternalLink className="w-3.5 h-3.5" />
                </a>
              </div>
            </div>
          ))}
